...
fishgg<- firstplot +
  xlab("Coefficient d'agglomération = 0.76")+
  ylab("Distance")+
  theme_classic()+
...
plot(tree1, which=2, hang=-1, main= "Dendrogramme des taxons démersaux", xlab="Coefficient d'agglomération = 0.81")
...
fishgg<- firstplot +
  xlab("Coefficient d'agglomération = 0.81")+
  ylab("Distance")+
  theme_classic()+
  theme(plot.title = element_text(size = 40, hjust = 0.5))+
  theme(axis.title.x = element_text(size = 35)) +
