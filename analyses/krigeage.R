...
#  sd.year <- sqrt(mean(db.CGFS.std[,"DensNb"][sel]^2) - mean(db.CGFS.std[,"DensNb"][sel])^2)  
...
#  plot(vg.data,npairdw=T,inches=0.1,col=rgb(0,0,0,0.25),add=!(i==1996), las=1,xlab="Distance (km)") }
...
# Boucle vario/krigeage sur tout les clusters (sans logarithme)
